<?php
/**
 * survey_pager.php along with survey_pager.php provides a sample web application
 *
 * The difference between survey_list.php and survey_list_pager.php is the reference to the 
 ...
 * 
 * @package SurveySez
 * @author Jonathan Steadman <jonathanbsteadman@gmail.com>
 * @version 1.0 2015/02/03
 * @link http://www.jonathanbsteadman.com/
...
{#records exist - process
	...
	{# process each row
         echo '<div align="center"><a href="' . VIRTUAL_PATH . 'surveys/survey_view.php?id=' . (int)$row['SurveyID'] . '"> Survey Title: '  . dbOut($row['Title']) . '<br/>Date Added: ' . dbOut($row['DateAdded']) . '<br/>Description: ' . dbOut($row['Description']) . '<br/>Created by: ' . dbOut($row['AdminName']) . '</a>';
         echo '</div>';
         /*
